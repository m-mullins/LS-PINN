...
def get_config():
    ...
    training.max_steps = 10 # 20000
    training.batch_size_per_device = 64 # 2048
    ...
    weighting.init_weights = ml_collections.ConfigDict({"ic_p": 1.0, "rp": 1.0, "mass_p": 1.0}) # lambda
