...
def get_config():
    ...
    wandb.name = "sota_s2s_vortex"
    wandb.tag = ["vortex"]
    wandb.notes = "mass_p = 100"

    # Nondimensionalization
    config.nondim = nondim = ml_collections.ConfigDict()
    nondim.nondimensionalize = False # Doesn't work fully
    nondim.X_star = 1.0
    nondim.Y_star = 1.0
    nondim.P_star = 1
    nondim.V_star = 1
    ...
    weighting.init_weights = ml_collections.ConfigDict({"ic_p": 1.0, "rp": 1.0, "mass_p": 100.0}) # lambda
