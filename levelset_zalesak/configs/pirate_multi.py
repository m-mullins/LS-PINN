...
def get_config():
    ...
    config.mode = "train_eval_multi"   # "eval_s2s" or "train_eval_s2s" or "train_eval_multi"
    ...
    wandb.name = "pirate_multi"
    wandb.tag = ["zalesak"]
    wandb.notes = "test multi"
    ...
    training1.batch_size_per_device = 256 # 256
